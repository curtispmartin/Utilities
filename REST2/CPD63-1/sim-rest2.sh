...
#---------------------------------------------------#
### set effective temperature range (i.e. scaling parameters)
smin=0.3
smax=1.0
...
### calculate distance b/w ligand & residues where halogen bond might exist in P8V (a H in 9YA)
